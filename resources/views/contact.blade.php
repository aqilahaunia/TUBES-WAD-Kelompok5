                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" id="firstNameLabel" placeholder="Raafi Asta" type="text"  name="name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" id="EmailLabel" placeholder="raafiasta@abadi_green.com" type="email" name="email" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
