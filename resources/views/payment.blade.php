        ...
        <div class="col-12 col-lg-12 text-center">
            <div class="nav-wrapper">
                <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="tab" href="#tabs-icons-text-2" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false">Card</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="tabs-icons-text-3" role="tabpanel" aria-labelledby="tabs-icons-text-3-tab">
                            <form action="{{route('checkout.paypal')}}" method="post">
                                @csrf
                                <p>We're sorry, this service currently under maintenance :(</p>
                                <button type="submit" class="btn btn-lg btn-primary">Ok! I Understand</button>
                            </form>                        
                        </div>
                    </div>
                </div>
